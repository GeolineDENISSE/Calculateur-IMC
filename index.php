            ...
            <div id="imc-result" class="p-2 form-control">
                ...
                ?>
                    <div id="imc-category" class="form-control border-danger">
                        <p class="text-danger-emphasis text-center"><?php echo $phrase . $etat ?></p>
                    </div>
                <?php
                elseif ($imc > 30):
                ...
                ?>
                    <div id="imc-category" class="form-control border-danger-subtle">
                        <p class="text-danger text-center"><?php echo $phrase . $etat ?></p>
                    </div>
                <?php
                elseif ($imc > 25):
                    $etat = "surpoids !"
                ?>
                    <div id="imc-category" class="form-control border-warning">
                        <p class="text-warning-emphasis text-center"><?php echo $phrase . $etat ?></p>
                    </div>
                <?php
                elseif ($imc > 18.5):
                ...
                ?>
                    <div id="imc-category" class="form-control border-info-subtle">
                        <p class="text-primary text-center"><?php echo $phrase . $etat ?></p>
                    </div>
                <?php
                elseif ($imc <= 18.5) :
